...
<body
	style="background-color: #1c77ac; background-image: url(<%=basePath%>/resources/images/light.png); background-repeat: no-repeat; background-position: center top; overflow: hidden;">
			...
			<ul>
				<form action="login.action" method="post">
					<li><input name="username" type="text" class="loginuser"
						value="zhangsan" onclick="JavaScript:this.value=''" /></li>
					<li><input name="password" type="password" class="loginpwd"
						value="1234" onclick="JavaScript:this.value=''" /></li>
